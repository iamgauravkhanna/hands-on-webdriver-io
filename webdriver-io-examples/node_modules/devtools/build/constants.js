...
exports.DEFAULT_X_POSITION = DEFAULT_X_POSITION;
const DEFAULT_Y_POSITION = 0;
exports.DEFAULT_Y_POSITION = DEFAULT_Y_POSITION;
const ELEMENT_KEY = 'element-6066-11e4-a52e-4f735466cecf';
exports.ELEMENT_KEY = ELEMENT_KEY;
const DEFAULT_FLAGS = ['--disable-extensions', '--disable-background-networking', '--disable-background-timer-throttling', '--disable-backgrounding-occluded-windows', '--disable-sync', '--metrics-recording-only', '--disable-default-apps', '--mute-audio', '--no-first-run', '--disable-hang-monitor', '--disable-prompt-on-repost', '--disable-client-side-phishing-detection', '--password-store=basic', '--use-mock-keychain', '--disable-component-extensions-with-background-pages', '--disable-breakpad', '--disable-dev-shm-usage', '--disable-ipc-flooding-protection', '--disable-renderer-backgrounding', '--enable-features=NetworkService,NetworkServiceInProcess', '--disable-features=site-per-process,TranslateUI,BlinkGenPropertyTrees'];
exports.DEFAULT_FLAGS = DEFAULT_FLAGS;
const CHROME_NAMES = ['chrome', 'googlechrome', 'headlesschrome', 'google-chrome', 'chromium'];
exports.CHROME_NAMES = CHROME_NAMES;
const FIREFOX_NAMES = ['firefox', 'ff', 'mozilla', 'mozillafirefox', 'headless firefox', 'headlessfirefox'];
exports.FIREFOX_NAMES = FIREFOX_NAMES;
const EDGE_NAMES = ['edge', 'msedge', 'microsoft-edge', 'microsoftedge'];
...
const DEFAULT_IMPLICIT_TIMEOUT = 0;
exports.DEFAULT_IMPLICIT_TIMEOUT = DEFAULT_IMPLICIT_TIMEOUT;
const DEFAULT_PAGELOAD_TIMEOUT = 5 * 60 * 1000;
exports.DEFAULT_PAGELOAD_TIMEOUT = DEFAULT_PAGELOAD_TIMEOUT;
const DEFAULT_SCRIPT_TIMEOUT = 30 * 1000;
exports.DEFAULT_SCRIPT_TIMEOUT = DEFAULT_SCRIPT_TIMEOUT;
const SUPPORTED_SELECTOR_STRATEGIES = ['css selector', 'tag name', 'xpath', 'link text', 'partial link text'];
exports.SUPPORTED_SELECTOR_STRATEGIES = SUPPORTED_SELECTOR_STRATEGIES;
const SERIALIZE_PROPERTY = 'data-devtoolsdriver-fetchedElement';
exports.SERIALIZE_PROPERTY = SERIALIZE_PROPERTY;
const SERIALIZE_FLAG = '__executeElement';
exports.SERIALIZE_FLAG = SERIALIZE_FLAG;
